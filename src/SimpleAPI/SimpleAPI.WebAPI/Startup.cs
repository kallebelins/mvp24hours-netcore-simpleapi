...
using SimpleAPI.WebAPI.Extensions;
...
namespace SimpleAPI.WebAPI
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMvp24HoursSwagger("v1", "Simple API", xmlCommentsFileName: "SimpleAPI.WebAPI.xml");
            //services.AddMvp24HoursRedisCache(Configuration, "ProCliDbRedis");
            services.AddMvp24HoursDbAsyncService<SimpleAPIContext>();
