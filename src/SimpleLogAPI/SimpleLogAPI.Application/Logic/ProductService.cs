...
using SimpleLogAPI.Core.Resources;
using SimpleLogAPI.Core.Specifications.ProductCategories;
using SimpleLogAPI.Core.Specifications.Products;
...
namespace SimpleLogAPI.Application.Logic
{
